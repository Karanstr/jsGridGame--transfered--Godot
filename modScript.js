...
window.a.Load('8401 8411 8421 8441 8451 84a1 8501 8511 8571 85d1 85f1 8601 8621 8681 86a1 86b1 86e1 8771 87a1 87b1 87d1 87e1')
window.a.findCorners()

window.p = new Region(250, 50, 20, 20, new blockMap('#ffffff'));
